...
const teachers = [
  {
    ...
    bio: 'With over 10 years of experience in digital marketing and AI, Alex helps entrepreneurs leverage cutting-edge tools to scale their businesses.',
  ...
  },
  {
    ...
    bio: 'Sarah specializes in helping startups build scalable business models using AI. Former tech executive with experience at Google and Meta.',
    imageUrl: '/teachers/sarah.jpg',
    linkedInUrl: 'https://linkedin.com/in/sarahchen'
  },
  {
    name: 'Michael Rodriguez',
    role: 'Digital Marketing Expert',
    bio: 'Michael has helped over 200 businesses implement AI-driven marketing strategies that deliver measurable results and sustainable growth.',
    imageUrl: '/teachers/michael.jpg',
